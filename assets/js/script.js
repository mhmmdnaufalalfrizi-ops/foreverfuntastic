...
// 2. Taruh filenya di folder: assets/img/social/
// 3. Isi nama filenya di bawah ini. Kosongkan "" kalau belum ada.
const TIKTOK_SCREENSHOT = "tiktok-profile.jpg"; // taruh file screenshot-mu di assets/img/social/ dengan nama ini
const SOCIAL_IMG_PATH = "assets/img/social/";
...
const MEMBERS = [
  ...
  { name: "Aira Agusnia Kamilah", ig: "@username2", photo: "" },
  { name: "Alin Fahrani Habibah", ig: "@username3", photo: "" },
  { name: "Ayesha Nur Frisky", ig: "@username4", photo: "" },
  { name: "Cherryl Aulia Octaviany Sofyan", ig: "@username5", photo: "" },
  { name: "Diah Septian Nurbaeti Hasanah", ig: "@username6", photo: "" },
  { name: "Dila Suci Rahmawati", ig: "@username7", photo: "" },
  { name: "Dilla Oktavia Hertika", ig: "@username8", photo: "" },
  { name: "Dimas Khairul Azzam", ig: "@username9", photo: "" },
  { name: "Eri Nurhayati", ig: "@username10", photo: "" },
  { name: "Fadlan Aryastya Adhidrawa", ig: "@username11", photo: "" },
  { name: "Faiha' Ulayya Zakiyah Mulyana Putri", ig: "@username12", photo: "" },
  { name: "Fauziatu Diniyah", ig: "@username13", photo: "" },
  { name: "Fellyana Ramadhani", ig: "@username14", photo: "" },
  { name: "Finsa Ramadani Arifin", ig: "@username15", photo: "" },
  { name: "Gaby Rahma Nabila", ig: "@username16", photo: "" },
  { name: "Ghaida El Amira", ig: "@username17", photo: "" },
  { name: "Jelita Nurindah", ig: "@username18", photo: "" },
  { name: "Mila Amelya", ig: "@username19", photo: "" },
  { name: "Mirza Raharja", ig: "@username20", photo: "" },
  { name: "Muhammad Ahzan Alqori Nasbiallah", ig: "@username21", photo: "" },
  { name: "Muhammad Naufal Alfarizi", ig: "@username22", photo: "" },
  { name: "N-Sya Naila Syafaq", ig: "@username23", photo: "" },
  { name: "Nadila Rahmatullah", ig: "@username24", photo: "" },
  { name: "Naila Jahra Nur'arifa", ig: "@username25", photo: "" },
  { name: "Neng Ayra Nuraini", ig: "@username26", photo: "" },
  { name: "Popon", ig: "@username27", photo: "" },
  { name: "Rafka Faiza Arkana", ig: "@username28", photo: "" },
  { name: "Ra'i Bazil Saleh", ig: "@username29", photo: "" },
  { name: "Ridha Khairunnisa", ig: "@username30", photo: "" },
  { name: "Riki Pebriansyah", ig: "@username31", photo: "" },
  { name: "Risma Amelia Solihah", ig: "@username32", photo: "" },
  { name: "Sinta Suci Ati", ig: "@username33", photo: "" },
  { name: "Siti Hasanatul Asziah", ig: "@username34", photo: "" },
  { name: "Siti Zulfatunnafiisah", ig: "@username35", photo: "" },
  { name: "Syaifa Yassirly Az Zahra", ig: "@username36", photo: "" },
  { name: "Syifa Ramadhani Pramudita", ig: "@username37", photo: "" },
  { name: "Tasya Almanda Juliani", ig: "@username38", photo: "" },
  { name: "Tatan Taufik Nurrohman", ig: "@username39", photo: "" },
  { name: "Tiara Azhari Rahimi", ig: "@username40", photo: "" },
  { name: "Vallent Althaf Vembrianto", ig: "@username41", photo: "" },
  { name: "Vidya Najla Gunawan", ig: "@username42", photo: "" },
  { name: "Yogan Hanggara", ig: "@username43", photo: "" },
  { name: "Zawwajuz Zayyan Fishshiyam", ig: "@username44", photo: "" },
];
...
function renderSocialEmbeds() {
    ...
    if (INSTAGRAM_EMBED_URL) {
      ...
      igWrap.innerHTML = `
        <div class="social-placeholder">
          ...
          <p>Instagram cuma bisa embed 1 POSTINGAN/REEL,<br>
             bukan seluruh profil. Tempel link post di<br>
             <code>INSTAGRAM_EMBED_URL</code> pada assets/js/script.js.<br>
             Untuk profil, pakai tombol Follow di atas.</p>
        </div>`;
    }
  }
  ...
  if (ttWrap) {
    if (TIKTOK_SCREENSHOT) {
      // Cara paling stabil: pakai screenshot, klik gambar -> buka TikTok asli
      ttWrap.innerHTML = `
        <a href="${TIKTOK_EMBED_URL || "#"}" target="_blank" rel="noopener" class="social-screenshot-link">
          <img src="${SOCIAL_IMG_PATH}${TIKTOK_SCREENSHOT}" alt="Profil TikTok">
        </a>`;
    } else if (TIKTOK_EMBED_URL) {
      // Link video bisa berupa /video/123..., atau link pendek
      // vt.tiktok.com / vm.tiktok.com (selalu mengarah ke 1 postingan).
      const isVideoLink =
        TIKTOK_EMBED_URL.includes("/video/") ||
        TIKTOK_EMBED_URL.includes("vt.tiktok.com") ||
        TIKTOK_EMBED_URL.includes("vm.tiktok.com");
      if (isVideoLink) {
        // Link 1 video spesifik -> embed resmi TikTok (kadang gagal muat
        // tergantung koneksi/pemblokir iklan; kalau sering gagal, pakai
        // screenshot lewat TIKTOK_SCREENSHOT di atas, lebih stabil).
        ...
        // Link profil -> TikTok TIDAK menyediakan embed resmi untuk profil
        // biasa, jadi dibuat kartu profil sendiri (bukan iframe TikTok asli)
        // supaya tidak muncul "Video currently unavailable".
        const match = TIKTOK_EMBED_URL.match(/@([^/?]+)/);
        const username = match ? match[1] : "TikTok";
        ttWrap.innerHTML = `
          <div class="social-placeholder tiktok-profile-card">
            <div class="note-icon">🎵</div>
            <p>@${username}</p>
            <p style="font-size:0.95rem;">TikTok tidak mendukung embed profil untuk
               akun biasa. Kunjungi langsung profilnya, atau isi
               <code>TIKTOK_SCREENSHOT</code> dengan screenshot profil
               supaya tampil lebih rapi.</p>
            <a href="${TIKTOK_EMBED_URL}" target="_blank" rel="noopener" class="btn btn-outline pixel-corners">Buka Profil TikTok</a>
          </div>`;
      }
    } else {
      ttWrap.innerHTML = `
        <div class="social-placeholder">
          ...
          <p>Tempel link 1 video di <code>TIKTOK_EMBED_URL</code><br>
